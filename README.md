...
Built this because most A/B test write-ups stop at "treatment group had higher conversion, ship it" without addressing selection bias or heterogeneous effects. This project demonstrates what a proper causal pipeline looks like end-to-end.
